...
namespace vietlabs.fr2
{
    ...
    // }
	 ...
	 public abstract class FR2_WindowBase : EditorWindow, IWindow{
		...
		public void AddItemsToMenu(GenericMenu menu)
        {
            ...
            menu.AddDisabledItem(new GUIContent("FR2 - v2.4.1"));
 ...
 protected abstract void OnReady();
		...
		protected bool CheckDrawHeader()
		{
            ...
            {
                EditorGUILayout.HelpBox("Compiling scripts, please wait!", UnityEditor.MessageType.Warning);
                Repaint();
                return false; 
            }
            ...
            {
                EditorGUILayout.HelpBox("Importing assets, please wait!", UnityEditor.MessageType.Warning);
                Repaint();
                return false; 
            }
            ...
            GUILayout.BeginHorizontal(EditorStyles.toolbar);
            {
                ...
                var icon = Icon.icons.Lock;
                if (lockSelection) icon = Icon.icons.LockOn;

                var v = GUILayout.Toggle(lockSelection, icon, EditorStyles.toolbarButton, GUILayout.Width(21f));
