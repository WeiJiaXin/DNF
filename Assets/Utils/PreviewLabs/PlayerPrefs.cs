...
namespace PreviewLabs
{
    public static class PlayerPrefs
    {
        ...
        private static readonly string fileName = Application.persistentDataPath + "/$@FQR#FQWE$";
        private static readonly string secureFileName = Application.persistentDataPath + "/$J#9-FH@#cfwq$";

        private static byte[] bytes =
            ASCIIEncoding.ASCII.GetBytes("l$-O" + SystemInfo.deviceUniqueIdentifier.Substring(0, 4));
